            ...
            >
              <div>
                ...
                <p className="text-zinc-400 leading-relaxed">
                  We collaborate with brands, agencies, and creators to craft meaningful motion experiences.
                </p>
              </div>
              ...
              <div className="space-y-6 text-sm">
                <div>
                  ...
                  <a
                    href="mailto:hello@snappymotions.com"
            ...
            >
              <div>
                ...
                <input
                  ...
                  type="text"
                  className="w-full bg-transparent border-b border-zinc-700 focus:border-orange-500 outline-none py-3 text-white"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="w-full bg-transparent border-b border-zinc-700 focus:border-orange-500 outline-none py-3 text-white resize-none"
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-6 bg-orange-600 hover:bg-orange-500 disabled:opacity-50 text-white text-xs font-bold uppercase tracking-widest px-10 py-5 rounded-full transition-all hover:scale-105 active:scale-95"
              >
